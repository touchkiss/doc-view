# Capability: Record Type Support

## Purpose

Support JDK 16+ record classes throughout the Doc View plugin's document generation pipeline. Record classes shall be recognized as documentable types, routed correctly, and have their components extracted for field-level documentation in all relevant contexts (direct POJO targets, Spring/Dubbo interface parameters, and the tool window).
